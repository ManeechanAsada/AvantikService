...
namespace Avantik.Web.Service.Model.COM
{
    public class FeeService : RunComplus, IFeeService
    {
        ...
        public IList<Entity.Booking.Fee> CalculateFeesSpecialService(string AgencyCode,
                                                        string currency,
                                                        Booking booking,
                                                        string strLanguage,
                                                        bool bNovat)
        ...
        public IList<Entity.Booking.Fee> GetBaggageFee(IList<Mapping> mapping, Guid bookingSegmentId, Guid passengerId, string agencyCode, string languageCode, int maxUnits, IList<Entity.Booking.Fee> fees, bool bNovat)
        {
