...
using Avantik.Web.Service.Entity.Booking.REST;
using Booking = Avantik.Web.Service.Entity.Booking.Booking;
...
namespace Avantik.Web.Service.Model.COM
{
    public class PaymentService : RunComplus, IPaymentService
    {
        ...
        public bool SavePayment(IList<Payment> payments, 
        ...
        public bool PaymentCreditCard(Booking booking,
                                    IList<PaymentAllocation> paymentAllocations,
                                    string securityToken,
                                    string authenticationToken,
                                    string commerceIndicator,
                                    string bookingReference, string requestSource,
                                    bool createTickets,
                                    bool readBooking,
                                    bool readOnly)
        {
