                    ...
                    using (DBHelper db = new DBHelper(_connectionString))
                    {
                        ...
                        if (rw != null && rw.HasRows)
                        {
                            ...
                            while (rw.Read())
                            {
                                ...
                                a.redemption_points = rw.DBToDecimal("redemption_points");
                                a.adult_fare = rw.DBToDecimal("adult_fare");
                                a.child_fare = rw.DBToDecimal("child_fare");
                                a.infant_fare = rw.DBToDecimal("infant_fare");
                                a.other_fare = rw.DBToDecimal("other_fare");

                                a.adult_fare_excl = rw.DBToDecimal("adult_fare_excl"); ;
                                a.child_fare_excl = rw.DBToDecimal("child_fare_excl"); ;
                                a.infant_fare_excl = rw.DBToDecimal("infant_fare_excl"); ;
                                a.other_fare_excl = rw.DBToDecimal("other_fare_excl"); ;
