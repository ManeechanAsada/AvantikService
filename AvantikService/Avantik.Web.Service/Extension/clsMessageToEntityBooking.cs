    ...
    public static class MessageToEntityBooking
    {
        ...
        public static FlightSegment ToEntity(this  Message.Booking.FlightSegment segment)
        {
            ...
            if (segment != null)
            {
                ...
                flightSegment.SegmentChangeStatusRcd = null;
        ...
        public static Passenger ToEntity(this  Message.Booking.Passenger p)
        {
            ...
            if (p != null)
            {
                ...
                passenger.KnownTravelerNumber = p.KnownTravelerNumber;
                //EDWDEV-81
               // passenger.PnrFirstname = p.PnrFirstName;
               // passenger.PnrLastname = p.PnrLastName;
            }
        ...
        public static Mapping ToEntity(this  Message.Booking.Mapping mapping)
        {
            ...
            if (mapping != null)
            {
                ...
                #endregion
                //EDWIBENEW
                passengerMapping.CreateBy = Guid.Empty;
                passengerMapping.UpdateBy = Guid.Empty;
                passengerMapping.OdOriginRcd = mapping.OriginRcd;
                passengerMapping.OdDestinationRcd = mapping.DestinationRcd;
        ...
        public static Fee ToEntity(this  Message.Booking.Fee f)
        {
            ...
            if (f != null)
            {
                ...
                fee.PassengerSegmentServiceId = Guid.Empty;
