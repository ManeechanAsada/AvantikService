...
namespace Avantik.Web.Service.Entity.Booking
{
    ...
    //    public int? arrival_day_change { get; set; } = null;
     //   public byte? iet_added_segment { get; set; } = null;

        //public int? arrival_day_change { get; set; }  //EDWIBENEW
        //public byte? iet_added_segment { get; set; }  //EDWIBENEW
        #endregion
    }
}
